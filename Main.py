...
sinusoid_scalars = [np.random.uniform(0.05, 0.01),
                    ...
                    np.random.uniform(5.0, 10.0)]
print(sinusoid_scalars)
def sinusoid(x):
  # return sinusoid_scalars[0]*np.exp(-(np.square(x-sinusoid_scalars[1]))[..., 0]*sinusoid_scalars[2])
  return (1/(np.sqrt(2*np.pi)*sinusoid_scalars[0])*np.exp(-(np.square(x-sinusoid_scalars[1]))[..., 0]*sinusoid_scalars[2]) + 
          1/(np.sqrt(2*np.pi)*sinusoid_scalars[3])*np.exp(-(np.square(x-sinusoid_scalars[4]))[..., 0]*sinusoid_scalars[5]))
